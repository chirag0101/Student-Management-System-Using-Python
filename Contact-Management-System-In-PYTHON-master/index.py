...
Top.pack(side=TOP)
Mid = Frame(root, width=500,  bg="#63b8ff")
Mid.pack(side=TOP)
MidLeft = Frame(Mid, width=100)
MidLeft.pack(side=LEFT, pady=10)
MidLeftPadding = Frame(Mid, width=370, bg="#63b8ff")
...
btn_add.pack()
btn_delete = Button(MidRight, text="DELETE", bg="#ffa500", command=DeleteData)
